The benefits of tail recursion optimization is evident on  method execution that would otherwise run out of stack space. Consider for example the following program.
